...
class OnosCHO:
    ...
    def CASE1(self, main):
        ...
        for i in range(1,int(numCtrls)+1):
            ...
            u_result= main.ONOSbench.onos_uninstall(node=ONOS_ip)
    ...
    def CASE3(self,main) :
        ...
        linksResult = main.ONOScli1.onos_links()
    ...
    def CASE9(self):
        ...
        for i in range(len(deviceLinks_copy)):
            ...
            installResult = main.ONOScli1.add_point_intent(point1[0], int(point1[1]), point2[0], int(point2[1]))
