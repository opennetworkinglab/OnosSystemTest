...
of RAMCloud server are shut down.
'''
class HATestRCFC2:
    ...
    def CASE5(self,main) :
        ...
        main.step("2 instances of RAMCloud Server Failure!")
        main.log.report("Randomly killing two instances of RAMCloud Server")
        global kill
        global kill2
        kill = randint(1,5)
        ramcloud_Killed = main.FALSE
        if kill==1:
            main.RC1.kill_serv()
            ramcloud_Killed = ramcloud_Killed or main.RC1.status_serv()
        elif kill==2:
            main.RC2.kill_serv()
            ramcloud_Killed = ramcloud_Killed or main.RC2.status_serv()
        elif kill==3:
            main.RC3.kill_serv()
            ramcloud_Killed = ramcloud_Killed or main.RC3.status_serv()
        elif kill==4:
            main.RC4.kill_serv()
            ramcloud_Killed = ramcloud_Killed or main.RC4.status_serv()
        elif kill==5:
            main.RC5.kill_serv()
            ramcloud_Killed = ramcloud_Killed or main.RC5.status_serv()
        ...
        if kill2==1:
            ...
            main.RC5.kill_serv()
            ramcloud_Killed = ramcloud_Killed or main.RC5.status_serv()
        main.log.info("Killed RAMCloud%s server and RAMCloud%s server" % (kill, kill2))
        utilities.assert_equals(expect=main.FALSE,actual=ramcloud_Killed,
                onpass="RAMCloud servers killed", onfail="Failed to kill RAMCloud servers")
    ...
    def CASE6(self,main) :
        ...
        if Switch_Mastership==main.TRUE:
            main.log.report("No changes to switch mastership")
        utilities.assert_equals(expect=main.TRUE,actual=Switch_Mastership,
                onpass="No changes to switch mastership",
                onfail="Changes were made to switch mastership")
