 ...
 */
public class TAITopology extends Application {

    public TAITopology() {
    }
    ObservableList<TAITopologyInterface> data;
    TableView<TAITopologyInterface> deviceTable;
    TableColumn device;
    TableColumn number;
    TableColumn type;
    int count = 1;
    ...
    public void start(final Stage primaryStage) {
        ...
        deviceTable = new TableView<TAITopologyInterface>();
        data = FXCollections.observableArrayList(new TAITopologyInterface(interFaceNumber, attributeText, valueText));
        deviceTable.setMinWidth(330);
        deviceTable.setMaxHeight(200);
        number = new TableColumn(label.topoInterfaces);
        number.setCellValueFactory(new PropertyValueFactory<TAITopologyInterface, Label>("interFaceNumber"));
        number.setMinWidth(90);
        number.setResizable(false);
        device = new TableColumn(label.topoAttribute);
        device.setCellValueFactory(new PropertyValueFactory<TAITopologyInterface, TextField>("deviceName"));
        device.setMaxWidth(119);
        device.setResizable(false);
        type = new TableColumn(label.topoValues);
        type.setCellValueFactory(new PropertyValueFactory<TAITopologyInterface, TextField>("deviceType"));
    ...
    public void addInterFace() {
        ...
        valueList.add(valueText);
        data.add(new TAITopologyInterface(interFaceNumber, attributeText, valueText));
        number.setCellValueFactory(new PropertyValueFactory<TAITopologyInterface, Label>("interFaceNumber"));
        number.setMinWidth(90);
        number.setResizable(false);
        device.setCellValueFactory(new PropertyValueFactory<TAITopologyInterface, TextField>("deviceName"));
