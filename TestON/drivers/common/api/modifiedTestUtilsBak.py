...
def ofmsgSndCmp(snd_list, exp_list, swList, contList, xid_ignore=False, hdr_only=False, ignore_cookie=True, cookies=[]):
    """
    Wrapper method for comparing received message and expected message
    See ofmsgSndCmpWithXid()
    """
    (success, ret_xid) = ofmsgSndCmpWithXid(snd_list, exp_list, swList, contList, xid_ignore, hdr_only, ignore_cookie, cookies)
    return success
	
def ofmsgSndCmpWithXid(snd_list, exp_list, swList, contList, xid_ignore=False, hdr_only=False, ignore_cookie=True, cookies=[]):
    """
