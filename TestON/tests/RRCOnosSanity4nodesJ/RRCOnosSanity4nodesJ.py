...
#Tests the startup of Zookeeper1, RamCloud1, and ONOS1 to be certain that all started up successfully
    def CASE1(self,main) :  #Check to be sure ZK, Cass, and ONOS are up, then get ONOS version
        ...
        main.step("stop onos")
        main.ONOS1.handle.sendline("cp ~/onos.properties.reactive ~/ONOS/conf/onos.sanity-rc-onos1.properties")
        main.ONOS2.handle.sendline("cp ~/onos.properties.reactive ~/ONOS/conf/onos.sanity-rc-onos2.properties")
        main.ONOS3.handle.sendline("cp ~/onos.properties.reactive ~/ONOS/conf/onos.sanity-rc-onos3.properties")
        main.ONOS4.handle.sendline("cp ~/onos.properties.reactive ~/ONOS/conf/onos.sanity-rc-onos4.properties")
        main.ONOS1.stop_all()        
        main.ONOS2.stop_all()        
        main.ONOS3.stop_all()        
        main.ONOS4.stop_all() 
