...
public class TAILocale {
    ...
    String okayButton, cancelButton, btSave, btRestoreDefaults, saveConfigTree, deleteConfigTree, addDevice, newFile, openFile;
    ...
    public TAILocale(Locale currentLocale){
        ...
        newFile = (String) resource.handleObject("newfile");
        openFile = (String) resource.handleObject("openfile");        
        ...
        okayButton = (String) resource.handleObject("add");
        cancelButton = (String) resource.handleObject("cancel");
        saveConfigTree = (String) resource.handleObject("saveConfigTree");
        deleteConfigTree = (String) resource.handleObject("deleteconfigtree");
        addDevice = (String) resource.handleObject("adddevice");
        
        //ConfigSettings
        
        btSave = (String) resource.handleObject("save");
        btRestoreDefaults = (String) resource.handleObject("restoredefaults");
