...
def createTopo():
  return {
    ...
    "switches": {
        ...
        "s1": { "dpid": "0000000000000001", "controllers": [ "onos-vm", "onos2-vm" ] },
        "s2": { "dpid": "0000000000000002", "controllers": [ "onos-vm", "onos2-vm" ] },
        "s3": { "dpid": "0000000000000003", "controllers": [ "onos-vm", "onos2-vm" ] },
        "s4": { "dpid": "0000000000000004", "controllers": [ "onos2-vm", "onos-vm" ] },
        "s5": { "dpid": "0000000000000005", "controllers": [ "onos2-vm", "onos-vm" ] },
	"s6": { "dpid": "0000000000000006", "controllers": [ "onos2-vm", "onos-vm" ] }
    },
    "hosts": {
