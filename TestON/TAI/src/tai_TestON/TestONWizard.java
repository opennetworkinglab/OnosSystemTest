 ...
 */
public class TestONWizard extends Application {
    ...
    public TestONWizard(TreeItem<String> root, int i, ObservableList<TreeItem<String>> listProject1, TreeView<String> projectTree1) {
        rootItem = root;
        caseNumber = i;
    ...
    public void setOFA(TAI_TestON ofa) {
...
class NewWizard extends Wizard {
    ...
    public NewWizard(Stage owner, TreeItem<String> treeItem, TAI_TestON reference, int caseNumber, final ObservableList<TreeItem<String>> listProject1, TreeView<String> projectTree1) {
        super();
        ...
        switch (caseNumber) {
            ...
            case 3:
                ...
                while (projectList2.hasNext()) {
                    ...
                    projectComb.getValue();
                    if (projectComb.getValue().equals("tests")) {
                        Iterator<TreeItem<String>> projectList3 = projectComb.getChildren().iterator();
                        while (projectList3.hasNext()) {
                            TreeItem<String> projectComb1 = projectList3.next();
                            testWizard.projectNameList.getItems().add(projectComb1.getValue());
                        }
                    }
    ...
    public void finish() {
        ...
        while (i < nodeList.size()) {
            ...
            if (node.getId().equals(label.wizProjectWizardId)) {
                ...
                projectNameTree = new TAILoadTree(name);


                for (int j = 0; j < projectExplorerTreeItem.getChildren().size(); j++) {
                    if (projectExplorerTreeItem.getChildren().get(j).getValue().equals("tests")) {
                        projectExplorerTreeItem.getChildren().get(j).getChildren().add(projectNameTree);
                    }
                }
                ...
                for (int index = 0; index < referenceOFA.projectExplorerTree.getChildren().size(); index++) {
                    if (referenceOFA.projectExplorerTree.getChildren().get(index).getValue().equals("tests")) {
                        for (int k = 0; k < referenceOFA.projectExplorerTree.getChildren().get(index).getChildren().size(); k++) {
                            if (referenceOFA.projectExplorerTree.getChildren().get(index).getChildren().get(k).
                                    getValue().equals(selectedProject)) {

                                pathParams = OFAUiPath + selectedProject;
                                Path name = new File(OFAUiPath + selectedProject + "/" + paramName).toPath();
                                TAILoadTree testSelection = new TAILoadTree(name);

                                Path paramsName = new File(name + ".params").toPath();
                                paramsFileName = paramsName.toString();
                                TAILoadTree paramsTestTree = new TAILoadTree(paramsName);
                                paramsTestTree.setValue(paramName);
                                referenceOFA.projectExplorerTree.getChildren().get(index).getChildren().get(k).getChildren().addAll(paramsTestTree);
                                try {
                ...
                if (testTopologyName != null) {
                    ...
                    for (int index = 0; index < referenceOFA.projectExplorerTree.getChildren().size(); index++) {
                        if (referenceOFA.projectExplorerTree.getChildren().get(index).getValue().equals("tests")) {
                            for (int indx = 0; indx < referenceOFA.projectExplorerTree.getChildren().get(index).getChildren().size(); indx++) {
                                if (referenceOFA.projectExplorerTree.getChildren().get(index).getChildren().get(indx).getValue().equals(projectNames)) {
                                    ...
                                    TAILoadTree topoTestTree = new TAILoadTree(topoName);
                                    ...
                                    referenceOFA.projectExplorerTree.getChildren().get(index).getChildren().get(indx).getChildren().addAll(topoTestTree);
                                    try {
...
class TopologyWizard extends WizardPage {
    ...
    HashMap<String, HashMap<String, HashMap<String, String>>> deviceDetailHash = new HashMap<String, HashMap<String, HashMap<String, String>>>();
    ...
    HashMap<String, Boolean> DeviceHash = new HashMap<String, Boolean>();
    ...
    void insertImage(Image i, final Pane hb, double x, double y) {
            ...
            public void handle(MouseEvent arg0) {
                if (anchorFlag == false) {
                    if (arg0.getClickCount() == 1) {
                        ...
                        TAIAnchorInsideImageNode mainAnchor = new TAIAnchorInsideImageNode(226.0, 41.0);
                ...
                if (arg0.getClickCount() == 2) {
                    if (deviceDetailHash.containsKey(content.getId())) {
                        int count = 1;
                        ...
                        if (deviceInfo[0].equals("fvtapidriver") || deviceInfo[0].equals("poxclidriver") || deviceInfo[0].equals("mininetclidriver") || deviceInfo[0].equals("dpctlclidriver")
                            ...
                            try {
                                ...
                                topoplogy.userNameText.setText(deviceDetailHash.get(content.getId()).get(text.getText()).get("UserName"));
                                topoplogy.hostNameText.setText(deviceDetailHash.get(content.getId()).get(text.getText()).get("HostName"));
                                topoplogy.passwordText.setText(deviceDetailHash.get(content.getId()).get(text.getText()).get("Password"));

                                TAITopologyInterface topologyInterface = new TAITopologyInterface(interFaceNumber, topoplogy.attributeText, topoplogy.valueText);
                                for (Map.Entry<String, String> entry : deviceDetailHash.get(content.getId()).get(text.getText()).entrySet()) {
                                    if (!entry.getKey().equals("UserName") && !entry.getKey().equals("HostName") && !entry.getKey().equals("Password")) {

                                        topologyInterface.setInterFaceNumber(interFaceNumber);
                                        topoplogy.attributeText.setText(entry.getKey());
                                        topoplogy.valueText.setText(entry.getValue());
                                        topologyInterface.setDeviceName(topoplogy.attributeText);
                                        topologyInterface.setDeviceType(topoplogy.valueText);
                            ...
                            topoplogy.save.setOnAction(new EventHandler<ActionEvent>() {
                                ...
                                public void handle(ActionEvent arg0) {
                                    ...
                                    HashMap<String, HashMap<String, String>> subDeviceDetails = new HashMap<String, HashMap<String, String>>();
                                    HashMap<String, String> propertyDeviceDetails = new HashMap<String, String>();
                                    propertyDeviceDetails.put("HostName", topoplogy.getHostName);
                                    propertyDeviceDetails.put("UserName", topoplogy.getUserName);
                                    propertyDeviceDetails.put("Password", topoplogy.getPassword);
                                    ...
                                    for (int i = 0; i < topoplogy.deviceTable.getItems().size(); i++) {
                                        ...
                                        propertyDeviceDetails.put(topoplogy.deviceTable.getSelectionModel().getSelectedItem().getDeviceName().getText(), topoplogy.deviceTable.getSelectionModel().getSelectedItem().getDeviceType().getText());
                                        arrayOfInterFaceHash = new ArrayList<HashMap<String, String>>();
                                        arrayOfInterFaceHash.add(interFaceHashDetail);
                                    }

                                    if (subDeviceDetails.containsKey(text.getText())) {
                                        subDeviceDetails.clear();
                                        subDeviceDetails.put(text.getText(), propertyDeviceDetails);
                                    } else {
                                        subDeviceDetails.put(text.getText(), propertyDeviceDetails);
                                    }

                                    deviceDetailHash.put(content.getId(), subDeviceDetails);
        ...
        closeButton.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent arg0) {
                TAIAnchorInsideImageNode node = new TAIAnchorInsideImageNode(224.0, 41.0);
