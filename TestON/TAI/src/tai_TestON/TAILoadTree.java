 ...
 */
public class TAILoadTree extends TreeItem<String> {
    ...
    public TAILoadTree(Path file) {
        ...
        if (Files.isDirectory(file)) {
            ...
            } else  if ("tests".equals(file.getFileName().toString())) {
                Node rootIcon = new ImageView(new Image(getClass().getResourceAsStream("/images/project.jpeg"), 20, 20, true, true));
                this.setGraphic(rootIcon);
            } else  if ("examples".equals(file.getFileName().toString())) {
                Node rootIcon = new ImageView(new Image(getClass().getResourceAsStream("/images/project.jpeg"), 20, 20, true, true));
                this.setGraphic(rootIcon);
        ...
        this.addEventHandler(TreeItem.branchExpandedEvent(), new EventHandler() {
            ...
            public void handle(Event e) {
                TAILoadTree source = (TAILoadTree) e.getSource();
                ...
                try {
                    if (source.getChildren().isEmpty()) {
                        ...
                        if (attribs.isDirectory()) {
                            ...
                            for (Path file : dir) {
                                TAILoadTree treeNode = new TAILoadTree(file);
