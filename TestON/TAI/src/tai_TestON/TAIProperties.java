    ...
    public Object handleObject(String key){
      //Set TestON Hierarchy path here
       ...
       if (key.equals("OFAHarnessPath")){
           ...
           // return "/home/paxterra/TAI_TestON/src/";
        }    
        ...
        if(key.equals("saveConfigTree")){
            return "Configtree";
        }
        if(key.equals("deleteConfig")){
            return "Deleteconfigtree";
        }
        if(key.equals("addDevice")){
            return "Deviceadd";
        }
        if(key.equals("btSave")){
            return "save";
        }
        if(key.equals("btRestoreDefaults")){
